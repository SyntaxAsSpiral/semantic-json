 ...
 */
function createCanvasNodeFromSourceCLI(sourceNode, generateId) {
 ...
 */
function extractSemanticFieldsCLI(text) {
  const result = {};
 ...
 */
function calculateNodeHeightCLI(node) {
  const baseHeight = 60;
 ...
 */
function extractSemanticInfoCLI(node) {
  if (!node.text || typeof node.text !== 'string') {
