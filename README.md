...
By default, Obsidian scrambles `.canvas` file entries on every save (arbitrary z-index ordering). This plugin encodes them into a stable, semantically meaningful structure without affecting:
