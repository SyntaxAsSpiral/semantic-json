...
By default, Obsidian "scrambles" the z-index array on every save, losing spatial and structural meaning. This plugin rearranges the array, encoding four visual dimensions into stable, deterministic JSON:
